...
This folder contains the outputs of the **Beta Calibration** step, applied to each True Distribution Shape (TDS).  
...
- **Calibration method**: Beta Calibration, using `betacal` package.
